import Myo.data_processing.pre_processing as pre_processing
...
#             data_filename = directory_levels[-1]
#
#             # gesture_label added is two characters long, the second of which is -
#             # therefore if the second character is a -, remove the first two characters
#             if data_filename[1] == "-":
#                 directory_levels[-1] = directory_levels[-1][2:]
#                 old_filename = "/".join(directory_levels)
#                 os.rename((self.path_to_test_data + "/" + file), (self.path_to_test_data + "/" + old_filename))
#
...
#                 directory_levels[-1] = directory_levels[-1][2:]
#                 old_filename = "\\".join(directory_levels)
#                 os.rename(file, (self.path_to_test_data + "/" + old_filename))
#
...
#
#         for filename in self.correct_filenames:
#             result = pre_processing.rename_data_files(time_stamps=self.time_stamps,
...
class GetPerformanceTimeStamps(unittest.TestCase):
    ...
    def test_return_all_time_stamps(self):
        ...
        self.assertEqual(pre_processing.get_performance_time_stamps(), all_time_stamps)
#
